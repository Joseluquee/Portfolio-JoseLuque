...
&nbsp;  - Loss de validación cada `validation\_freq` épocas  

&nbsp;  - Accuracy de validación cada `validation\_freq` épocas  
...
git clone https://github.com/Joseluquee/Portfolio-JoseLuque.git
